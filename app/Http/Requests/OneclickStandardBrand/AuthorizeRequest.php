...
class AuthorizeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'details.0.browserAcceptHeader' => 'present|nullable|string|max:512',
            'details.0.browserUserAgent' => 'present|nullable|string|max:512',
            'details.0.browserIP' => 'present|nullable|ip',
            'details.0.browserJavaEnabled' => 'required|boolean',
            'details.0.browserScreenHeight' => 'present|nullable|integer|min:1|max:10000',
            'details.0.browserScreenWidth' => 'present|nullable|integer|min:1|max:10000',
            'details.0.browserTZ' => 'present|nullable|integer|min:-840|max:840',
