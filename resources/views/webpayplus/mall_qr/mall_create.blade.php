...
<form class="webpay_form" action="createMall" method="post" style="display: flex; flex-direction:column; width:50%;font-size: 20px;">
    ...
    @if (app()->environment('production'))
        <label for="merchant_1_active">Comercio 1</label>
        ...
        <label for="merchant_2_active">Comercio 2</label>
        ...
        <label for="merchant_3_active">Comercio 3</label>
        <input type="checkbox" id="cbox3" value="1">

        <label for="merchant_3_amount">Monto comercio #3</label>
        <input id="merchant_3_amount" name="detail[2][amount]" value="2000">

        <label for="merchant_3_commerce_code">Código comercio del comercio #3</label>
        ...
        <label for="merchant_3_buy_order">Orden de compra comercio #3</label>
