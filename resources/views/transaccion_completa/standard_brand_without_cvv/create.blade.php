...
<div class="w-full max-w-none">
    <h1 class="mb-2">Ejemplo Transacción Completa Estándar Marca sin CVV</h1>
    <p class="text-gray-700 mb-6">
        Ingresa los datos de la tarjeta, comercio y autenticación para crear la transacción estándar marca sin CVV.
    </p>

    <form action="/transaccion_completa/standard_brand_without_cvv/create" method="post" class="tbk-form-stack-lg">
        @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="tbk-field">
                        ...
                        <input id="buy_order" class="w-full" type="text" name="buy_order" value="{{ '123456' . rand(1,1000) }}" required />
                    </div>

                    <div class="tbk-field">
                        <label for="session_id">Id de sesión</label>
                        <input id="session_id" class="w-full" type="text" name="session_id" value="{{ $sessionId ?? '' }}" required />
                    </div>
                </div>
                <div>
                    ...
                    <div class="tbk-field">
                        ...
                        <input id="card_expiration_date" class="w-full" type="text" name="card_expiration_date" placeholder="YY/MM" maxlength="5" pattern="^\d{2}\/(0[1-9]|1[0-2])$" title="Usa formato YY/MM" inputmode="numeric" required />
                    </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="tbk-field">
                    ...
                    <input id="details_amount" class="w-full" type="text" name="details[0][amount]" required />
                </div>
                ...
                <div class="tbk-field">
                    ...
                    <input id="details_buy_order" class="w-full" type="text" name="details[0][buy_order]" value="{{ '123456' . rand(1,1000) }}" required />
                </div>

                <div class="tbk-field">
                    <label for="details_post_entry_mod">Post entry mode</label>
                    <select id="details_post_entry_mod" class="w-full" name="details[0][post_entry_mod]" required>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div class="tbk-field">
                    <label for="details_tid">Transaction ID</label>
                    <input id="details_tid" class="w-full" type="text" name="details[0][tid]" maxlength="20" />
                </div>
    ...
    <div class="sb-section">
        <a class="tbk-btn-link" href="/transaccion_completa/standard_brand_without_cvv/account-verify">Verificación de cuenta</a>
    </div>
</div>
