...
<div class="w-full max-w-none">
    <h1 class="mb-2">Transacción Completa Estándar Marca sin CVV confirmada</h1>
    <p class="text-gray-700 mb-6">
        La autorización estándar marca sin CVV fue confirmada. Desde aquí puedes consultar estado o solicitar reembolso.
    </p>
    ...
    <div class="w-full bg-white border border-gray-200 rounded-lg p-4 mb-8">
        ...
        <form class="tbk-form-stack" action="/transaccion_completa/standard_brand_without_cvv/refund" method="post">
            @csrf
            <div>
