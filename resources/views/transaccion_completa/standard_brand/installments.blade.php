...
<div class="w-full max-w-none">
    <h1 class="mb-2">Cuotas consultadas Transacción Completa Estándar Marca</h1>
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-4 mb-8">
        ...
        <form class="tbk-form-stack" action="/transaccion_completa/standard_brand/commit" method="post">
            @csrf
            <div>
