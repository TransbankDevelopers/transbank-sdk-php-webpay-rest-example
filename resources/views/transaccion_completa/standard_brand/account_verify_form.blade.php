...
<div class="w-full max-w-none">
    <h1 class="mb-2">Verificación de Cuenta Transacción Completa Estándar Marca</h1>
    <p class="text-gray-700 mb-6">
        Ingresa los datos de tarjeta, autenticación y comercio para verificar la cuenta.
    </p>

    <form action="/transaccion_completa/standard_brand/account-verify" method="post" class="tbk-form-stack-lg">
        @csrf
