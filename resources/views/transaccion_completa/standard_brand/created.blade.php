...
<div class="w-full max-w-none">
    <h1 class="mb-2">Transacción Completa Estándar Marca creada</h1>
    <p class="text-gray-700 mb-6">
        La transacción estándar marca fue creada correctamente. Puedes confirmar directamente o consultar cuotas antes de confirmar.
    </p>
    ...
    <div class="mb-8">
        <div class="bg-white border border-gray-200 rounded-lg p-4 mb-6">
            ...
            <form class="tbk-form-stack tbk-form-stack-flex" action="/transaccion_completa/standard_brand/commit" method="post">
                @csrf
                <div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-4 w-full">
            ...
            <form class="tbk-form-stack tbk-form-stack-flex" method="post" action="/transaccion_completa/standard_brand/installments">
                @csrf
                <div>
